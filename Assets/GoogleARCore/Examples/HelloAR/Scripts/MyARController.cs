...
namespace GoogleARCore.MyHello
{
        ...
        public void Update()
        {
            ...
            if (Frame.Raycast(touch.position.x, touch.position.y, raycastFilter, out hit))
            {
                ...
                else
                {
                    ...
                    GameObject prefab = GameObject.Find("shino-sendagaya");
                    if (!prefab)
                    {
                        prefab = Instantiate(Shino_chan, hit.Pose.position, hit.Pose.rotation);
                        prefab.name = "shino-sendagaya";
                    }
                    else
                    {
                    ...
                    if (!prefab.GetComponent<JointDataManager>())
                    {
                        prefab.AddComponent<JointDataManager>();
                    }
